...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "editattendance")) {
...
<form action="<?php echo $editFormAction; ?>" method="post" name="editattendance" id="editattendance">
  <table align="center" width="80%">
    ...
    <tr valign="baseline">
      ...
      <td><input type="date" name="date" value="<?php echo htmlentities($row_rstable3['tb3_colunm2'], ENT_COMPAT, 'utf-8'); ?>" readonly /></td>
    </tr>
  ...
  <input type="hidden" name="tb3_colunm3" value="<?php if ($_GET['action'] == Attend && $row_rstable3 == NULL) {echo date('H:i');} else{ echo htmlentities($row_rstable3['tb3_colunm3'], ENT_COMPAT, 'utf-8'); } ?>" />
  <input type="hidden" name="tb3_colunm4" value="<?php if ($_GET['action'] == OUT && $row_rstable4 == NULL) {echo date('H:i');} else{ echo htmlentities($row_rstable3['tb3_colunm4'], ENT_COMPAT, 'utf-8'); } ?>" />
  <input type="hidden" name="tb3_colunm5" value="<?php if ($_GET['action'] == IN && $row_rstable5 == NULL) {echo date('H:i');} else{ echo htmlentities($row_rstable3['tb3_colunm5'], ENT_COMPAT, 'utf-8'); } ?>" />
  <input type="hidden" name="tb3_colunm6" value="<?php if ($_GET['action'] == Leave && $row_rstable6 == NULL) {echo date('H:i');} else{ echo htmlentities($row_rstable3['tb3_colunm6'], ENT_COMPAT, 'utf-8'); } ?>" />
  <input type="hidden" name="tb3_colunm9" value="<?php echo htmlentities($row_rstable3['tb3_colunm9'], ENT_COMPAT, 'utf-8'); ?>"  />
  <input type="hidden" name="tb3_colunm10" value="<?php echo htmlentities($row_rstable3['tb3_colunm10'], ENT_COMPAT, 'utf-8'); ?>"  />
  <input type="hidden" name="tb3_colunm11" value="<?php echo htmlentities($row_rstable3['tb3_colunm11'], ENT_COMPAT, 'utf-8'); ?>"  />
  <input type="hidden" name="tb3_colunm12" value="<?php echo htmlentities($row_rstable3['tb3_colunm12'], ENT_COMPAT, 'utf-8'); ?>"  />
  <input type="hidden" name="tb3_colunm13" value="<?php echo $_GET['image4']; ?>"  />
  <input type="hidden" name="MM_update" value="editattendance" />
