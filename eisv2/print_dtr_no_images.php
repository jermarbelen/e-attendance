...
RUNTIME <?php echo date("h:i:sa"); ?> </font></td>
  ...
  <tr>
    ...
    <td></td>
    <td></td>
    <td align="right"><a href="javascript:window.print()"><img src="../images/b_print.png" alt="PRINT" title="PRINT"></a></td>
  </tr>
  <tr>
    <td>Position:</td>
    ...
    var demoParams = [
      {
        title: "",
        config: {
          text: "http://172.16.32.14/denr/eisv2/print_dtr_no_images.php?date=<?php echo $_GET['date']; ?>&user_id=<?php echo $_GET['user_id'] ;?>",
